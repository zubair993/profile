			...
			<div class="col-12">
				<nav aria-label="breadcrumb">
				  <ol class="breadcrumb">
				    ...
				    <li class="breadcrumb-item active" aria-current="page">Best Activities</li>
				  </ol>
				</nav>
				<h2>Best Activities in Senior Living Awards 2023</h2>
			</div>
		</div>
	</div>
</section>
		...
		<div class="row">
			<div class="col-lg-8 col-md-8 col-sm-6 col-12">
				<div class="th_content">
					<h2>Honoring top-rated senior living activities</h2>
...
<style type="text/css">
	.th_critaria_sec{background-color: #f7f3ef;padding:48px 140px;margin-bottom:80px}
...
<section>
	<div class="container">
		<div class="th_critaria_sec">
			<div class="row">
				<div class="col-12">
					<h2>Best Activities 2023 Awards criteria</h2>
				</div>
				...
				<div class="col-12">
					<small>*Based on reviews collected from APlaceforMom.com during the awards period of July 10, 2023 to Aug. 18, 2023.</small>
				</div>
			</div>
		</div>
	</div>
