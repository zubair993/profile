	...
	<div class="container th_breadcrumb_sec">
		<div class="row">
			<div class="col-12">
				...
				<h2>Most Friendly in Senior Living Awards 2023</h2>
			</div>
		</div>
	</div>
</section>
		...
		<div class="row">
			<div class="col-lg-8 col-md-8 col-sm-6 col-12">
				<div class="th_content">
					<h2>Highest-rated senior living communities</h2>
...
<style type="text/css">
	.th_critaria_sec{background-color: #f7f3ef;padding:48px 140px;}
